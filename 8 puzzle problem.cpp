...
// Program to get the current(given) puzzle to its given final condition(state).
// this program assume that given puzzle is solvable (as not every puzzle can reach its goal state). 
#include<iostream>
#include<cstdlib>
#include<queue>
using namespace std;
